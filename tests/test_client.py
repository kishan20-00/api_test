...
from api_test import APITest, AsyncAPITest, APIResponseValidationError
from api_test._types import Omit
from api_test._utils import asyncify
from api_test._models import BaseModel, FinalRequestOptions
from api_test._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from api_test._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: APITest | AsyncAPITest) -> int:
...
class TestAPITest:
    client = APITest(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "api_test/_legacy_response.py",
                        "api_test/_response.py",
    ...
    def test_client_timeout_option(self) -> None:
        client = APITest(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_validate_headers(self) -> None:
        ...
        with update_env(**{"API_TEST_API_KEY": Omit()}):
            client2 = APITest(base_url=base_url, api_key=None, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, client: APITest) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = APITest(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(API_TEST_BASE_URL="http://localhost:5000/from/env"):
            client = APITest(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            APITest(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            APITest(
    ...
    def test_base_url_trailing_slash(self, client: APITest) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: APITest) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: APITest) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            APITest(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = APITest(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = APITest(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_omit_retry_count_header(
        self, client: APITest, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncAPITest:
    client = AsyncAPITest(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with update_env(**{"API_TEST_API_KEY": Omit()}):
            client2 = AsyncAPITest(base_url=base_url, api_key=None, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncAPITest) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(API_TEST_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncAPITest(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncAPITest) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncAPITest) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncAPITest) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncAPITest(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncAPITest(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncAPITest, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
