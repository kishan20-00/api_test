...
class LoginResource(SyncAPIResource):
    ...
    def github(
        ...
        *,
        ...
        Returns: RedirectResponse: A response that redirects the user to GitHub.
    ...
    def google(
        ...
        *,
        ...
        Redirects the user to the Google authorization
        page.

        Args: request: The FastAPI Request object.

        Returns: RedirectResponse: A response that redirects the user to Google.

        Raises: HTTPException: 500 If Google OAuth is not configured.
        """
        return self._get(
            "/auth/login/google",
            options=make_request_options(
...
class LoginResourceWithRawResponse:
    def __init__(self, login: LoginResource) -> None:
        ...
        self.github = to_raw_response_wrapper(
            login.github,
        )
        self.google = to_raw_response_wrapper(
            login.google,
        )
...
class AsyncLoginResourceWithRawResponse:
    def __init__(self, login: AsyncLoginResource) -> None:
        ...
        self.github = async_to_raw_response_wrapper(
            login.github,
        )
        self.google = async_to_raw_response_wrapper(
            login.google,
        )
...
class LoginResourceWithStreamingResponse:
    def __init__(self, login: LoginResource) -> None:
        ...
        self.github = to_streamed_response_wrapper(
            login.github,
        )
        self.google = to_streamed_response_wrapper(
            login.google,
        )
...
class AsyncLoginResourceWithStreamingResponse:
    def __init__(self, login: AsyncLoginResource) -> None:
        ...
        self.github = async_to_streamed_response_wrapper(
            login.github,
        )
        self.google = async_to_streamed_response_wrapper(
            login.google,
        )
