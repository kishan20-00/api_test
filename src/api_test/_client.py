...
class APITest(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous APITest client instance.

        This automatically infers the `api_key` argument from the `API_TEST_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("API_TEST_API_KEY")
...
class AsyncAPITest(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncAPITest client instance.
